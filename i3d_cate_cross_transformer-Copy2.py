...
model_path = '/data2/jintao/msrvtt_global_local/train_model/i3d_cate_boundary2'
...
def train():
    ...
    loss_fd = open('./result_txt/i3d_cate_boundary2.txt', 'a')
    ...
    for epoch in range(0, n_epochs):
        ...
        saver.save(sess, os.path.join(model_path, 'i3d_cate_boundary22'), global_step=epoch)
        
        if epoch > -1:
        
            saver_valid.restore(sess_valid,'/data2/jintao/msrvtt_global_local/train_model/i3d_cate_boundary2/i3d_cate_boundary22-' + str(epoch))
...
def test(model_path='/data2/jintao/msrvtt_global_local/train_model/i3d_cate_boundary2/i3d_cate_boundary22-3'):
    test_data = get_video_test_data(video_test_data_path, video_test_feat_path, video_test_3d_path, video_test_mfcc_path, video_test_cate_path)
