...
def train():
    ...
    loss_fd = open('./result_txt/i3d_cate_restart.txt', 'a')
...
def test(model_path='/data1/jintao/msrvtt_global_local/train_model/i3d_cate_boundary2/i3d_cate_boundary22-3'):
    test_data = get_video_test_data(video_test_data_path, video_test_feat_path, video_test_3d_path, video_test_mfcc_path, video_test_cate_path)
